  ...
  return (
    ...
    >
      ...
      <div className="controls" style={embed ? { flex: 1, display: "flex", flexDirection: "column" } : undefined}>
        ...
        <div style={{ display: "flex", gap: "8px", alignItems: "flex-start", width: "100%", position: "relative" }}>
          ...
          <span style={{ fontWeight: "bold", fontSize: "14px", minWidth: 0, flex: 1, marginLeft: "28px" }}>Check this box to add a QR code and then add your website to the box that appears, for a scannable QR Code to your website.</span>
        </div>
        {qrEnabled && (
          <>
            <div className="field">
