      ...
      <div className="controls" style={embed ? { overflowY: "auto", flex: 1 } : undefined}>
        ...
        <div className="qr-block">
          <div style={{ display: "flex", gap: "4px", alignItems: "flex-start" }}>
            ...
            <span style={{ fontWeight: "bold", fontSize: "14px", lineHeight: "1.4" }}>Check this box to add a QR code and then add your website to the box that appears, for a scannable QR Code to your website.</span>
          </div>
          {qrEnabled && (
            <>
              <div className="field">
