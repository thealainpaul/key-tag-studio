    ...
    >
      ...
      <div className="controls" style={embed ? { flex: 1, display: "flex", flexDirection: "column" } : undefined}>
        ...
        <div style={{ display: "flex", gap: "8px", alignItems: "flex-start", width: "100%", flexWrap: "wrap" }}>
          ...
          <span style={{ fontWeight: "bold", fontSize: "14px", flex: 1 }}>Check this box to add a QR code and then add your website to the box that appears, for a scannable QR Code to your website.</span>
        </div>
        {qrEnabled && (
          <>
            <div className="field">
